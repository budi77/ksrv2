                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php echo e(@$row->payments_federation_sum_value ?? '0'); ?>



                                    </td>
                                    <td class="text-center">
                                          <?php if(@$value - @$row->payments_federation_sum_value == 0): ?>
                                                <span
                                                    class="badge text-bg-success text-uppercase"> <?php echo e(@$value - @$row->payments_federation_sum_value); ?>

                                                </span>

                                            <?php elseif((@$value - @$row->payments_sum_value) > 0 and (@$value - @$row->payments_federation_sum_value) < @$value): ?>
                                                <span
                                                    class="badge text-bg-warning text-uppercase"> <?php echo e(@$value - @$row->payments_federation_sum_value); ?>

                                                </span>
                                            <?php else: ?>
                                                <span
                                                    class="badge text-bg-danger text-uppercase"> <?php echo e(@$value - @$row->payments_federation_sum_value); ?>
...
<?php /**PATH D:\laragon\www\ksrv2\resources\views/livewire/fees/federations/show.blade.php ENDPATH**/ ?>