...
} elseif ($_instance->childHasBeenRendered('62kTixz')) {
    $componentId = $_instance->getRenderedChildComponentId('62kTixz');
    $componentTag = $_instance->getRenderedChildComponentTagName('62kTixz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('62kTixz');
} else {
    $response = \Livewire\Livewire::mount('modals', []);
    $html = $response->html();
    $_instance->logRenderedChild('62kTixz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
