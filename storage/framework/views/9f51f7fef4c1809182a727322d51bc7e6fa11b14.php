    ...
    <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(URL::asset('/index')); ?>">
                <img src="<?php echo e(URL::asset('assets/images/KSR.png')); ?>" class="card-logo card-logo-dark" alt="logo dark" height="70">
                <img src="<?php echo e(URL::asset('assets/images/KSR.png')); ?>" class="card-logo card-logo-light" alt="logo light"
                    height="17">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="">
                    ...
                    <a href="<?php echo e(URL::asset('/auth-signup-basic')); ?>" class="btn btn-primary">SISPAKS</a>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-sm-10">
                    <div class="text-center mt-lg-5 pt-5">
                        <h2 class="display-6 fw-semibold mb-3 lh-base">KELAB SUKAN DAN REKREASI (KSR) <span
                                class="text-muted">SURUHANJAYA PENCEGAHAN RASUAH MALAYSIA (SPRM) </span></h2>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\ksrv2\resources\views/landing.blade.php ENDPATH**/ ?>