...
<div class='fw-bold h3 text-primary'> BOLA TAMPAR WANITA</div>
<hr>
<div class="row">
                ...
                <table class="table table-secondary table-bordered table-striped text-center">
                    ...
                    <?php $__currentLoopData = $a; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="">
                            ...
                            <td><?php echo e($data->btwwon); ?></td>
                            <td><?php echo e($data->btwlost); ?></td>
                            <td><?php echo e($data->btwgoal); ?></td>
                            <td><?php echo e($data->btwagainst); ?></td>
                            <td><?php echo e($data->btwgoaldifference); ?> </td>
                            <td><?php echo e($data->btwpoints); ?></td>
                        </tr>
...
<?php /**PATH C:\laragon\www\ksrv2\resources\views/livewire/ksr-games24/bola-tampar-wanita/games.blade.php ENDPATH**/ ?>