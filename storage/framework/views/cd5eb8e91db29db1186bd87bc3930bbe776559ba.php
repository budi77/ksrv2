...
} elseif ($_instance->childHasBeenRendered('MMlFC2v')) {
    $componentId = $_instance->getRenderedChildComponentId('MMlFC2v');
    $componentTag = $_instance->getRenderedChildComponentTagName('MMlFC2v');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MMlFC2v');
} else {
    $response = \Livewire\Livewire::mount('dashboard.stat', []);
    $html = $response->html();
    $_instance->logRenderedChild('MMlFC2v', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
