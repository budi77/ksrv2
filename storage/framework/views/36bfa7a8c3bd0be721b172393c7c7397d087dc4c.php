...
<div class='fw-bold h3 text-primary'> KAROM</div>
<hr>
<div class="row">
                ...
                <table class="table table-secondary table-bordered table-striped text-center">
                    ...
                    <?php $__currentLoopData = $a; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="">
                            ...
                            <td><?php echo e($data->krwon); ?></td>
                            <td><?php echo e($data->krlost); ?></td>
                            <td><?php echo e($data->krgoal); ?></td>
                            <td><?php echo e($data->kragainst); ?></td>
                            <td><?php echo e($data->krgoaldifference); ?> </td>
                            <td><?php echo e($data->krpoints); ?></td>
                        </tr>
...
<?php /**PATH C:\laragon\www\ksrv2\resources\views/livewire/ksr-games24/karom/games.blade.php ENDPATH**/ ?>