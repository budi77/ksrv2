...
} elseif ($_instance->childHasBeenRendered('x079lBT')) {
    $componentId = $_instance->getRenderedChildComponentId('x079lBT');
    $componentTag = $_instance->getRenderedChildComponentTagName('x079lBT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('x079lBT');
} else {
    $response = \Livewire\Livewire::mount('dashboard.stat', []);
    $html = $response->html();
    $_instance->logRenderedChild('x079lBT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
