                        ...
                        <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td class="id"><a href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"
                                            class="fw-medium link-primary">#VLZ501</a></td>
                                    <td class="project_name"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"
                                            ...
                                            <div class="flex-shrink-0 ms-4">
                                                <ul class="list-inline tasks-list-menu mb-0">
                                                    <li class="list-inline-item"><a
                                                            href="<?php echo e(URL::asset('/apps-tasks-details')); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\ksrv2\resources\views/apps-tasks-list-view.blade.php ENDPATH**/ ?>