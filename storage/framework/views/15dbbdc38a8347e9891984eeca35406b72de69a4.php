...
} elseif ($_instance->childHasBeenRendered('3o18cwS')) {
    $componentId = $_instance->getRenderedChildComponentId('3o18cwS');
    $componentTag = $_instance->getRenderedChildComponentTagName('3o18cwS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3o18cwS');
} else {
    $response = \Livewire\Livewire::mount('modals', []);
    $html = $response->html();
    $_instance->logRenderedChild('3o18cwS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
