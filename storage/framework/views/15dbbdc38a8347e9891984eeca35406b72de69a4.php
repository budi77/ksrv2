...
} elseif ($_instance->childHasBeenRendered('s0JbRS8')) {
    $componentId = $_instance->getRenderedChildComponentId('s0JbRS8');
    $componentTag = $_instance->getRenderedChildComponentTagName('s0JbRS8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('s0JbRS8');
} else {
    $response = \Livewire\Livewire::mount('modals', []);
    $html = $response->html();
    $_instance->logRenderedChild('s0JbRS8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
