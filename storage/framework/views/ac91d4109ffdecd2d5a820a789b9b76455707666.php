<div>
    ...
    <a href="<?php echo e(url('storage/' . 'AGENDA_AGM15_KSR_TAHUN_2024.pdf')); ?>" target="_blank" class="list-group-item list-group-item-action text-primary"
        ><i class="bx bxs-file-pdf"></i> Agenda AGM KSR 2024</a
    >
    <a href="<?php echo e(url('storage/' . 'Minit_Mesyuarat_AGM_KSR_SPRM_Kali_ke_14_Tahun_2023.pdf')); ?>" target="_blank" class="list-group-item list-group-item-action text-primary"
        > <i class="bx bxs-file-pdf"></i> Minit Mesyuarat AGM KSR Kali ke 14 2023</a
    >
    <a href="<?php echo e(url('storage/' . 'sKSR_SPRM_2023_Annual_Report.pdf')); ?>" target="_blank" class="list-group-item list-group-item-action text-primary"
...
<?php /**PATH D:\laragon\www\ksrv2\resources\views/livewire/member/semakan.blade.php ENDPATH**/ ?>