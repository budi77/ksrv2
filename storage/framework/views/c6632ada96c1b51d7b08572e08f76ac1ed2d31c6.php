...
} elseif ($_instance->childHasBeenRendered('l1097755923-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1097755923-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1097755923-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1097755923-2');
} else {
    $response = \Livewire\Livewire::mount('settings.importmembers', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1097755923-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
