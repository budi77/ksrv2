...
namespace App\Http\Livewire\KsrGames24\TarikTaliLelaki;
...
class Games extends Component
{
    ...
    public function mount()
    {
        ...
        $this->sport_id = Sport::select('id')->whereName('TARIK TALI LELAKI')->first();
    ...
    public function render()
    {
        ...
        return view('livewire.ksr-games24.tarik-tali-lelaki.games', compact('a','fixtures'));
    }
