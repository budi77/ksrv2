...
namespace App\Http\Livewire\KsrGames24\Karom;
...
class Games extends Component
{
    ...
    public function mount()
    {
        ...
        $this->sport_id = Sport::select('id')->whereName('KAROM')->first();
    ...
    public function render()
    {
        ...
        return view('livewire.ksr-games24.karom.games', compact('a','b','fixtures'));
    }
