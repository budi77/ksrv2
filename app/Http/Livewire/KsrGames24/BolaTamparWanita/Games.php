...
namespace App\Http\Livewire\KsrGames24\BolaTamparWanita;
...
class Games extends Component
{
    ...
    public function mount()
    {
        ...
        $this->sport_id = Sport::select('id')->whereName('BOLA TAMPAR WANITA')->first();
    ...
    public function render()
    {
        ...
        return view('livewire.ksr-games24.bola-tampar-wanita.games', compact('a','b','fixtures'));
    }
