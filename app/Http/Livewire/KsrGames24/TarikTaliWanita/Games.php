...
namespace App\Http\Livewire\KsrGames24\TarikTaliWanita;
...
class Games extends Component
{
    ...
    public function mount()
    {
        ...
        $this->sport_id = Sport::select('id')->whereName('TARIK TALI WANITA')->first();
    ...
    public function render()
    {
        ...
        return view('livewire.ksr-games24.tarik-tali-wanita.games', compact('a','fixtures'));
    }
