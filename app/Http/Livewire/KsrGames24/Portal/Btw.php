...
class Btw extends Component
{
    public $data_id,  $match, $stage, $order,$court, $sport_id;

    public function render()
    {
        $this->sport_id = Sport::select('id','name','venue')->whereName('BOLA TAMPAR WANITA')->first();
        $id = $this->sport_id->id;
       ...
       $b = Contigent::whereHas('grp', function($q) use($id) {
        ...
        return view('livewire.ksr-games24.portal.btw', compact('a','b','fixtures'))->extends('layouts.master-without-nav');
    }
}
