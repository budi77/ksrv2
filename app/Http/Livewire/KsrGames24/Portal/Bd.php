...
class Bd extends Component
{
    ...
    {
        $this->sport_id = Sport::select('id','name','venue')->whereName('BADMINTON')->first();
        $id = $this->sport_id->id;
       ...
       $b = Contigent::whereHas('grp', function($q) use($id) {
        ...
        return view('livewire.ksr-games24.portal.bd', compact('a','b','fixtures'))->extends('layouts.master-without-nav');
    }
}
