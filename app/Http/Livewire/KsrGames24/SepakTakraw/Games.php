...
namespace App\Http\Livewire\KsrGames24\SepakTakraw;
...
class Games extends Component
{
    ...
    public function mount()
    {
        ...
        $this->sport_id = Sport::select('id')->whereName('SEPAK TAKRAW')->first();
    ...
    public function render()
    {
        ...
        return view('livewire.ksr-games24.sepak-takraw.games', compact('a','b','fixtures'));
    }
