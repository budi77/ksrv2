...
<div class="container">
    ...
    <a class="btn btn-primary bg-gradient bg-animation" href="{{route('ksrgames24.bs')}}" role="button">BADMINTON</a>
    ...
    <a class="btn btn-primary bg-gradient bg-animation" href="{{route('ksrgames24.bs')}}" role="button">BALAPAN</a>
    <a class="btn btn-primary bg-gradient bg-animation" href="{{route('ksrgames24.bs')}}" role="button">TARIK TALI</a>
    <a class="btn btn-primary bg-gradient bg-animation" href="{{route('ksrgames24.bs')}}" role="button">BOWLING</a>
    <a class="btn btn-primary bg-gradient bg-animation" href="{{route('ksrgames24.bs')}}" role="button">MENEMBAK</a>
