...
<div class="d-grid gap-2 pt-2" >
    <a class="btn btn-primary bg-gradient btn-lg" href="{{ URL::asset('documents/maccgames24/buku_manual_maccgame24.pdf') }}" role="button">BUKU PROGRAM</a>
    <a class="btn btn-secondary bg-gradient btn-lg" href="{{route('ksrgames24.program')}}" role="button">PROGRAM</a>
...
>
    ...
    >
        <div class="modal-content">
            ...
            <div class="modal-body">
            <img style="width:100%;" id="image" src="{{ URL::asset('documents/maccgames24/peta_lokasi_uitm.png') }}">
