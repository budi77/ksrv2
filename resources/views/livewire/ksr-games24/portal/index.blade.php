...
<div class="d-grid gap-2 pt-2" >
    <a class="btn btn-primary bg-gradient btn-lg" href="{{ URL::asset('documents/maccgames24/BUKU_ATUCARA_PENGUKUHAN_JATI_DIRI_SPRM_2024.pdf') }}" role="button">BUKU PROGRAM</a>
