...
<div class='fw-bold h3 ff-secondary text-center pt-2 cfs-22'> KAROM</div>
<div class='fw-bold h ff-secondary text-center '> {{ @$sport_id->venue }}</div>
<div class="text-center h5"><a href="https://maps.app.goo.gl/FVE1hZZ5mebtJeBh6"><i class="las la-map-marker-alt"></i> Google Maps</a></div>
                ...
                <table class="table table-secondary table-bordered table-striped text-center">
                    ...
                    @foreach($a as $key => $data)
                        <tr class="">
                            ...
                            <td>{{ $data->krlost }}</td>
                            <td>{{ $data->krgoal }}</td>
                            <td>{{ $data->kragainst }}</td>
                            <td>{{ $data->krgoaldifference  }} </td>
                            <td>{{ $data->krpoints }}</td>
                        </tr>
                        @endforeach
