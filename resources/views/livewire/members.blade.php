                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                ...
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" aria-label="Edit">
                                                    <a class="edit-item-btn" href="javascript:void(0);" wire:click="delete('{{ $result->id }}')" onclick="return confirm('Are you sure to delete?')"><i class="ri-trash-fill align-bottom text-danger"></i></a>
                                                </li>
