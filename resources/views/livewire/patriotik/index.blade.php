...
<button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalId">
    ...
    {{-- <i class="ri-todo-line fs-14 align-middle"></i>   --}}
        </button>

    <a class="btn btn-danger btn-sm" target="_blank" href="{{ asset('/documents/Syarat_syarat_pertandingan_patriotik2023.pdf') }}" role="button"><i class="ri-file-download-line fs-14 me-1 align-bottom"></i>MUAT TURUN SYARAT SYARAT PERTANDINGAN</a>
