            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid"
                            src="{{ URL::asset('assets/images/small/img-8.jpg') }}" alt="Card image cap">
                        <div class="card-footer">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid"
                            src="{{ URL::asset('assets/images/small/img-10.jpg') }}" alt="Card image cap">
                        <div class="card-footer">
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                            </p>
    ...
    <div class="row g-3">
        ...
        <div class="col-xxl col-6">
            <div class="card h-100">
                ...
                <img class="img-fluid" src="{{ URL::asset('assets/images/small/img-11.jpg') }}"
                    alt="Card image cap" />
                <div class="card-body">
